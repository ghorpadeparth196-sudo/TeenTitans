...
const villainList =
  document.querySelector("#villainList");
...
const episodePills =
  document.querySelector("#episodePills");
    ...
    button.addEventListener(
      ...
      () => {
        ...
        if (text === "♡ Save") {
          ...
          showToast(
            "Sign-in is coming soon for this fan project."
          );
...
function doSearch() {
  ...
  if (!query) {
    ...
    showToast(
      "Type a character, episode, or topic to search."
    );
  ...
  if (characterMatch) {
    ...
    openProfile(
      characters.indexOf(characterMatch)
    );
  ...
  if (villainMatch) {
    ...
    document
      .querySelector("#villains")
      ?.scrollIntoView({
        behavior: "smooth"
      });

    showToast(
      `Showing results for ${villainMatch.name}.`
    );
  ...
  showToast(
    `No result for "${searchInput.value}".`
  );
...
/* =========================================================
   MEDIA GALLERY
   Images are directly inside /images/
========================================================= */
...
if (gallery) {
  ...
  /* Make entire section visible */

  const gallerySection =
    gallery.closest(".wiki-section");
  ...
  /* Remove only old gallery grid */

  const oldGrid =
    gallery.querySelector(".gallery-grid");
...
/* =========================================================
   JUMP CITY WEBSITE BACKGROUND
========================================================= */

document.body.style.backgroundImage =
  "url('images/jump-city.jpg')";
...
/* =========================================================
   TITANS TEAM MASTHEAD BACKGROUND
========================================================= */

const mastheadInner =
  document.querySelector(".masthead-inner");

if (mastheadInner) {

  mastheadInner.style.backgroundImage =
    "url('images/titans-team.jpg')";

  mastheadInner.style.backgroundSize =
    "cover";

  mastheadInner.style.backgroundPosition =
    "center";

  mastheadInner.style.backgroundRepeat =
    "no-repeat";
...
if (welcomeArt) {
  ...
  welcomeArt.style.backgroundSize =
    "cover";

  welcomeArt.style.backgroundPosition =
    "center";

  welcomeArt.style.backgroundRepeat =
    "no-repeat";
